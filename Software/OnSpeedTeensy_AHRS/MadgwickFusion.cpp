...
#define sampleFreqDef   238.0f          // sample frequency in Hz
#define betaDef         0.018f            // 2 * proportional gain
...
void Madgwick::begin(float sampleFrequency, float Pitch, float Roll)
          ...
          float Yaw=0;
          float cr2 = cos(Roll*DEG2RAD*0.5);
          float cp2 = cos(Pitch*DEG2RAD*0.5);
          float cy2 = cos(Yaw*DEG2RAD*0.5);
          float sr2 = sin(Roll*DEG2RAD*0.5);
          float sp2 = sin(Pitch*DEG2RAD*0.5);
          float sy2 = sin(Yaw*DEG2RAD*0.5);
