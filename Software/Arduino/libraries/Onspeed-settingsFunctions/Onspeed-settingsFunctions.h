...
configString+=makeConfig("AX_BIAS",floatToString(axBias));
configString+=makeConfig("AY_BIAS",floatToString(ayBias));
configString+=makeConfig("AZ_BIAS",floatToString(azBias));
...
axBias=stringToFloat(getConfigValue(configString,"AX_BIAS"));
ayBias=stringToFloat(getConfigValue(configString,"AY_BIAS"));
azBias=stringToFloat(getConfigValue(configString,"AZ_BIAS"));
