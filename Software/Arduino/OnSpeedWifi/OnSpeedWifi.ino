...
String wifi_fw="3.0"; // wifi firmware version
...
void handleSensorConfig()
  ...
  if (server.arg("confirm").indexOf("yes")<0)
    ...
    page+="<br><br><p style=\"color:black\">This procedure will configure the system\'s accelerometers, gyros and pressure sensors.<br><br>\
    ...
    <label>Aicraft Pitch (degrees)</label>\
    <input class=\"inputField\" type=\"text\" name=\"pitchBias\" value=\"0.0\">\
    ...
    <a href=\"/\">Cancel</a>\
          ...
          {
          // configure sensors
          if (server.arg("pitchBias").indexOf("yes")<0)
              {
              pitchBias=server.arg("pitchBias").toFloat();
              } else pitchBias=0.0;     
                 
          Serial.printf("$SENSORCONFIG<PITCHBIAS>%2f</PITCHBIAS>!",pitchBias);
...
// dataSource
    page+="<div class=\"form-divs flex-col-12\">\
      ...
      <select id=\"id_dataSource\" name=\"dataSource\">\
        <option value=\"SENSORS\""; if (dataSource=="SENSORS") page+=" selected"; page+=">Sensors</option>\
 ...
 // logFileToReplay
    ...
    for (int flapIndex=0; flapIndex<flapDegrees.Count; flapIndex++)
        ...
        page+="<h2> Flap Curve "+String(flapIndex+1)+" </h2>\
              ...
              <label for=\"id_flapDegrees"+String(flapIndex)+"\">Flap Pos.</label>\
              ...
              <div class=\"form-divs flex-col-3\">\
              <label for=\"id_flapPotPositions"+String(flapIndex)+"\">Sensor Pos</label>\
              ...
              <div class=\"form-divs flex-col-3\">\
              <label for=\"id_flapDegrees"+String(flapIndex)+"Delete\">&nbsp</label>\
              <input id=\"id_flapDegrees"+String(flapIndex)+"Delete\" name=\"flapDegreesDelete"+String(flapIndex)+"\" type=\"submit\" value=\"Delete\" class=\"redbutton\"/>\
              </div>\
            ...
            // add flap position
             ...
             // efis settings
              ...
              page+="<div id=\"volumeControlDiv\" class=\"form-divs flex-col-"+volumeControlWidth+"\">\
                <label for=\"id_volumeControl\">Potentiometer Volume Control</label>\
              ...
              <div class=\"form-divs flex-col-6\">\
                <label for=\"id_muteAudioUnderIAS\">Mute audio under IAS (kts)</label>\
            ...
            //sensor biases                      
              ...
              page+="<div class=\"form-divs flex-col-4\">\
                    <div class=\"upload-btn-wrapper\">\
                        <button class=\"upload-btn\">Upload Config File</button>\
              ...
              page+="<div class=\"form-divs flex-col-5\">\
                  <a href=\"/defaultconfig\"><input id=\"id_loadDefaultConfig\" name=\"loadDefaultConfig\" type=\"button\" value=\"Load Default Config\" class=\"greybutton\"/></a>\
                  </div>";
               // save button
